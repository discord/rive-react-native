...
const RiveContainer = /*#__PURE__*/React.forwardRef(({
  ...
  useImperativeHandle(ref, () => ({
    ...
    viewTag
  }), [play, pause, stop, reset, setInputState, getBooleanState, getBooleanStateAtPath, getNumberState, getNumberStateAtPath, setInputStateAtPath, fireState, fireStateAtPath, touchBegan, touchEnded, setTextRunValue, setTextRunValueAtPath, setBoolean, setString, setNumber, setColor, setEnum, setImage, setArtboard, trigger, internalNativeEmitter, viewTag]);
